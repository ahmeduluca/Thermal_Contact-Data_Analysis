...
sample=[ ]
medium=[ ]
with open("acthermaltest1_40Hz_800mvac_28mvst.txt") as a:
    lines=a.readlines()
    for x in lines:
...
print(f)
print(g)
with open("tip_aver_40hz800mv.txt", "w") as n:
    for k in range(len(c)):
        n.write(str(c[k]))
        n.write ("                                                                        ")
with open("sample_aver_40hz800mv.txt", "w") as m:
    for l in range(len(f)):
        m.write(str(f[l]))
        m.write ("                                                                        ")
with open("medium_aver_40hz800mv.txt", "w") as o:
