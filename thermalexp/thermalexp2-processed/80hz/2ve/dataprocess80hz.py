...
sample=[ ]
medium=[ ]
with open("acthermaltest80hz2Vace.txt") as a:
    lines=a.readlines()
    for x in lines:
...
print(f)
print(g)
with open("tip_aver_80hz2ve.txt", "w") as n:
    for k in range(len(c)):
        n.write(str(c[k]))
        n.write ("                                                                        ")
with open("sample_aver_80hz2ve.txt", "w") as m:
    for l in range(len(c)):
        m.write(str(f[l]))
        m.write ("                                                                        ")
with open("medium_aver_80hz2ve.txt", "w") as o:
